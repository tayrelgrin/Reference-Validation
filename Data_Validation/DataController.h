...
public:
	...
	int CompareReference(CList<CompareResult*>& outLogData, CList<CompareResult*>& outDifferent, int inCount, int inConfigCount, bool inBasicCheck);
	...
	void CheckCommonInformation(int inIndex);
	bool CheckNamingRule(int inIndex);
